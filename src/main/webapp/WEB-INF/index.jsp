	...
	<div style="display: flex;">
		<nav class="nav flex-column"
			...
			<a class="nav-link active" aria-current="page" href="/posts"><svg
				...
				Profile</a> <a class="nav-link" href="/posts/${user_id}/bookmarks"><svg
					xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20"
					height="20" viewBox="0 0 172 172" style="fill: #000000;">
					<g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1"
						stroke-linecap="butt" stroke-linejoin="miter"
		...
		<div class="main"
			...
			<div class="d-flex"
				style="justify-content: center; padding: 20px; align-items: center; flex-direction: column; gap: 10px">
				<img alt="Chatter" src="https://see.fontimg.com/api/renderfont4/0nA4/eyJyIjoiZnMiLCJoIjo2NSwidyI6MTAwMCwiZnMiOjY1LCJmZ2MiOiIjRkZGRkZGIiwiYmdjIjoiIzAwMDAwMCIsInQiOjF9/Q0hBVFRFUg/bunch-blossoms-personal-use.png">
				<form:form action="/posts/new" method="post" modelAttribute="post">
					<form:input path="content" placeholder="Post something here..." />
					<form:errors path="content" />
					<form:input type="hidden" path="creator" value="${user_id}" />
					<form:button class="btn btn-primary">Post</form:button>
				</form:form>
			</div>
			<div>
